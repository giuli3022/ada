...
document.getElementById("hero");  // Cumple la misma funcion que el ej anterior. Trae un solo elemento
                                    //
...
document.querySelector(".miClase")    // trae el primero que encuentra. No devuelve en array
/**
